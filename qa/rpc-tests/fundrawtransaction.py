...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        inputs  = [ {'txid' : utx['txid'], 'vout' : utx['vout']}]
        # KatKoyn: Fee is exact, do not use tolerance
        ...
        inputs  = [ {'txid' : utx['txid'], 'vout' : utx['vout']} ]
        # KatKoyn: Reduce this output so the fee doesn't leave us with no change
        ...
        inputs = []
        # KatKoyn: TX size rounding gives us a fee of 4 KAT
