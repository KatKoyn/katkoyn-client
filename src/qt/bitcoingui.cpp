    ...
    platformStyle(_platformStyle)
{
    ...
    // Nyncoin: load fallback font in case Comic Sans is not availble on the system
  ...
  //  QFontDatabase::addApplicationFont(":fonts/ComicNeue-Light-Oblique");
   ...
   // QFont::insertSubstitution("Comic Sans MS", "Comic Neue");
    ...
    // Nyncoin: Specify Comic Sans as new font.
   // QFont newFont("Comic Sans MS", 10);

    // Nyncoin: Set new application font
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a KatKoyn address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and katkoyn: URIs)"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your KatKoyn addresses to prove you own them"));
    verifyMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified KatKoyn addresses"));
    ...
    openAction->setStatusTip(tr("Open a katkoyn: URI or payment request"));

    showHelpMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible KatKoyn command-line options").arg(tr(PACKAGE_NAME)));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        tooltip = tr("%n active connection(s) to KatKoyn network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
...
{
    QString strTitle = tr("KatKoyn"); // default title
