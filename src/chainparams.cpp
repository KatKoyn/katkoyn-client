...
public:
    CMainParams() {
        ...
        // XXX: BIP heights and hashes all need to be updated to Nyncoin values
        ...
        vSeeds.push_back(CDNSSeedData("tabby.katkoyn.org", "tabby.katkoyn.org", true));
        ...
        //bech32_hrp = "NONE";
        //TODO: fix this for nyncoin -- plddr
        vFixedSeeds.clear();
...
public:
    CTestNetParams() {
        ...
        consensus.nMajorityWindow = 1000;
        // BIP34 is never enforced in Nyncoin v2 blocks, so we enforce from v3
