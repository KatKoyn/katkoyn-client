...
public:
    CMainParams() {
        ...
        // XXX: BIP heights and hashes all need to be updated to KatKoyn values
        ...
        //bech32_hrp = "NONE";
        //TODO: fix this for katkoyn -- plddr
        vFixedSeeds.clear();
...
public:
    CTestNetParams() {
        ...
        consensus.nMajorityWindow = 1000;
        // BIP34 is never enforced in KatKoyn v2 blocks, so we enforce from v3
